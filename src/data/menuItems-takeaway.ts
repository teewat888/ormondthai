export const takeawayMenu = [
  {
    category: 'Entrée',
    categoryNumber: 1,
    categoryWideOptions: [{ type: 'Vegetable', price: 9.95 }],
    items: [
      {
        number: 1,
  ...
  },
  {
    ...
    categoryNumber: 2,
    categoryWideOptions: [
      { type: 'Vegetables', price: 9.95 },
      { type: 'Chicken', price: 11.95 },
      { type: 'Seafood', price: 13.95 },
    ],
    items: [
      {
        number: 9,
        name: 'Tom Yum',
        description:
          'Famous Thai Spicy soup with mushroom flavored with lemongrass and lime leaves.',
      },
      {
        number: 10,
        name: 'Tom Kha',
        description:
          'Delightful taste of coconut milk-based soup, with mushrooms, and a mild lemon flavor.',
      },
      {
        number: 11,
        name: 'Po Tak',
  ...
  },
  {
    ...
    categoryNumber: 3,
    categoryWideOptions: [
      { type: 'Beef', price: 15.95 },
      { type: 'Prawns/Calamari', price: 17.95 },
    ],
    items: [
      {
        number: 12,
        name: 'Nam Tok',
        description:
          'Traditional Thai spicy salad dressing with lemon juice, chili, mint, herb, and roasted ground rice.',
      },
      {
        number: 13,
        name: 'Laab',
  ...
  },
  {
    ...
    categoryNumber: 4,
    categoryWideOptions: [
      { type: 'Vegetable', price: 19.95 },
      { type: 'Chicken/Beef', price: 21.95 },
      { type: 'Prawns/Calamari', price: 23.95 },
    ],
    items: [
      {
        number: 18,
        name: 'Green Curry',
        description:
          'Famous Thai green curry prepared with green chili paste, coconut milk, fresh vegetables, and basil leaves.',
      },
      {
        number: 19,
        name: 'Red Curry',
        description:
          'Traditional Thai red curry simmered in coconut milk with fresh vegetables and basil leaves.',
      },
      {
        number: 20,
        name: 'Duck Curry',
  ...
  },
  {
    ...
    categoryWideOptions: [
      { type: 'Vegetable', price: 19.95 },
      { type: 'Chicken/Beef/Pork', price: 21.95 },
      { type: 'Seafood', price: 23.95 },
    ],
    items: [
      {
        number: 25,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: 27.95,
        description:
          'Crispy combination King prawn, calamari, chicken stir fried with vegetable, pineapple and cashew nuts in our chef special sauce.',
      },
    ],
  },
  {
    ...
    categoryNumber: 8,
    categoryWideOptions: [
      { type: 'Vegetable', price: 17.95 },
      { type: 'Chicken/Beef/Pork', price: 19.95 },
      { type: 'Prawns/Calamari', price: 21.95 },
    ],
    items: [
      {
        number: 43,
